...
// =============================================================================
    ...
    case (_isOfficer): {
        ...
        [_unit,[[_wsmoke,2],[_grenade,2],[_mapTools,1]]] call BRM_FMK_fnc_addtoVest;
    ...
    case (_isTeamLeader): {
        ...
        [_unit,[[_wsmoke,2],[_grenade,2]]] call BRM_FMK_fnc_addtoVest;
        [_unit, _commonRIFLE, _countRIFLE] call BRM_FMK_fnc_addWeaponKit;
        [_unit, _commonRIFLE select GUN, _countTracerRIFLE, ["TRACER"]] call BRM_FMK_fnc_addAmmoAuto;
        [_unit, _commonPISTOL, _countPISTOL] call BRM_FMK_fnc_addWeaponKit;
    ...
    case (_isReconLeader): {
        ...
        [_unit,[[_wsmoke,2],[_grenade,2],[_gsmoke,2],[_rchemlight,2],[_bchemlight,2],[_wflare,2],[_mapTools,1]]] call BRM_FMK_fnc_addtoVest;
        [_unit, ["ItemGPS"]] call BRM_FMK_fnc_linkItem;
        [_unit, "laserdesignator"] call BRM_FMK_fnc_addOptics;
    ...
    case (_isReconMedic): {
        ...
        [_unit, "binoc"] call BRM_FMK_fnc_addOptics;
        [_unit,[[_wsmoke,2],[_grenade,2],[_gsmoke,2],[_mapTools,1]]] call BRM_FMK_fnc_addtoVest;
        [_unit, _suppliesMEDIC] call BRM_FMK_fnc_addtoBackpack;
        [_unit, _commonRIFLE, _countRIFLE] call BRM_FMK_fnc_addWeaponKit;
        [_unit, "primary", _commonSUPPRESSOR] call BRM_FMK_fnc_attachToWeapon;
        _defaultInsignia = "MedB";
    ...
    case (_isSpotter): {
        ...
        [_unit,[[_wsmoke,2],[_grenade,2],[_gsmoke,2],[_mapTools,1],[_kestrel,1]]] call BRM_FMK_fnc_addtoVest;
